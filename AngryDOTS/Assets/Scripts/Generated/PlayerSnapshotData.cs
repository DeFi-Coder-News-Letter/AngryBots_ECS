...
public struct PlayerLightSnapshotData : ISnapshotData<PlayerLightSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref PlayerLightSnapshotData baseline1, ref PlayerLightSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref PlayerLightSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref PlayerLightSnapshotData baseline, ref DataStreamReader reader,
        NetworkCompressionModel compressionModel)
    {
        this.tick = tick;
        changeMask0 = reader.ReadPackedUIntDelta(baseline.changeMask0, compressionModel);
        if ((changeMask0 & (1 << 0)) != 0)
            PlayerComponentplayerId = reader.ReadPackedIntDelta(baseline.PlayerComponentplayerId, compressionModel);
        else
    ...
    public void Interpolate(ref PlayerLightSnapshotData target, float factor)
    {
